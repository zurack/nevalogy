 ...
 */
function seven_subtheme_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // seven_subtheme_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  seven_subtheme_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function seven_subtheme_preprocess_html(&$vars) {
 ...
 */
function seven_subtheme_preprocess_page(&$vars) {
 ...
 */
function seven_subtheme_node_add_list($variables) {
 ...
 */
function seven_subtheme_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function seven_subtheme_tablesort_indicator($variables) {
 ...
 */
function seven_subtheme_css_alter(&$css) {
